...
from app.chain.subscribe.verification import finish_or_continue_subscription
...
class SubscribeQueryOwner(_SubscribeOwnerBase):
    ...
    def check_and_handle_existing_media(
        ...
        # 如果已下载完毕：先过媒体库二次核验守卫，通过才 force 完成订阅
        if exist_flag:
            return finish_or_continue_subscription(self, subscribe, meta, mediainfo, no_exists)
